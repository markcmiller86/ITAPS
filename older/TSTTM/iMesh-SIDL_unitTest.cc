...
#ifndef BABEL_SERIAL
#define BABEL_SERIAL 1001010
#endif

#ifndef iMesh_LAST_ERROR_NOT_REQUIRED
typedef struct bleh {
  int error_type;
...
// is checked elsewhere (iMesh_precondTest.cc and
// iMesh_postcondTest.cc).

#define MAIN_PROGRAM
#include "iMesh-SIDL_unitTest.hh"
...
static void vSetupTypeAndTopo()
{
  ...
  //@@ Setup data
  for (eETopo = iMesh::EntityTopology_POINT;
       eETopo <= iMesh::EntityTopology_ALL_TOPOLOGIES;
       eETopo++) {
    for (eEType = iMesh::EntityType_VERTEX;
	 eEType < iMesh::EntityType_ALL_TYPES;
	 eEType++) {
      a2qLegalTypeAndTopo[eEType][eETopo] = false;
    }
    a2qLegalTypeAndTopo[iMesh::EntityType_ALL_TYPES][eETopo] = true;
  }

  a2qLegalTypeAndTopo[iMesh::EntityType_VERTEX]
    [iMesh::EntityTopology_POINT] = true;

  a2qLegalTypeAndTopo[iMesh::EntityType_EDGE]
    [iMesh::EntityTopology_LINE_SEGMENT] = true;

  a2qLegalTypeAndTopo[iMesh::EntityType_FACE]
    [iMesh::EntityTopology_TRIANGLE] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_FACE]
    [iMesh::EntityTopology_QUADRILATERAL] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_FACE]
    [iMesh::EntityTopology_POLYGON] = true;

  a2qLegalTypeAndTopo[iMesh::EntityType_REGION]
    [iMesh::EntityTopology_TETRAHEDRON] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_REGION]
    [iMesh::EntityTopology_PYRAMID] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_REGION]
    [iMesh::EntityTopology_PRISM] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_REGION]
    [iMesh::EntityTopology_HEXAHEDRON] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_REGION]
    [iMesh::EntityTopology_SEPTAHEDRON] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_REGION]
    [iMesh::EntityTopology_POLYHEDRON] = true;

  a2qLegalTypeAndTopo[iMesh::EntityType_VERTEX]
    [iMesh::EntityTopology_ALL_TOPOLOGIES] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_EDGE]
    [iMesh::EntityTopology_ALL_TOPOLOGIES] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_FACE]
    [iMesh::EntityTopology_ALL_TOPOLOGIES] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_REGION]
    [iMesh::EntityTopology_ALL_TOPOLOGIES] = true;
  a2qLegalTypeAndTopo[iMesh::EntityType_ALL_TYPES]
    [iMesh::EntityTopology_ALL_TOPOLOGIES] = true;
}

//@ Adjacency reciprocity test kernel

void vEntityReciprocityTest(iMesh::Entity& EntMesh,
			    iMesh::EntityType eET1, iMesh::EntityType eET2)
{
  // Iterate over entities of type eET1
  void* entIter;
  EntMesh.initEntIter(pvRootSet, eET1,
		      iMesh::EntityTopology_ALL_TOPOLOGIES, entIter);
...
void vArrayReciprocityTest(iMesh::Arr& ArrMesh,
		      iMesh::EntityType eET1, iMesh::EntityType eET2)
{
  try {
    ...
    int iNumEntities;
    ArrMesh.getEntities(pvRootSet, eET1, iMesh::EntityTopology_ALL_TOPOLOGIES,
...
static void vTestMeshInterface(iMesh::Mesh& Mesh,
			       string strFilename)
{
  try {
  ...
  iMesh::StorageOrder SODef;
  try {
    SODef = Mesh.getDfltStorage();
    TEST(SODef == iMesh::StorageOrder_BLOCKED ||
	 SODef == iMesh::StorageOrder_INTERLEAVED);
  }
  catch (iBase::Error TErr) {
  ...
  ::sidl::array<iMesh::AdjacencyInfo> saAdjTable;
  try {
    int iSize;
  ...
  a2iEntCount[iMesh::EntityType_VERTEX][iMesh::EntityTopology_POINT] =
    a2iEntCount[iMesh::EntityType_VERTEX]
      [iMesh::EntityTopology_ALL_TOPOLOGIES] =
    a2iEntCount[iMesh::EntityType_ALL_TYPES][iMesh::EntityTopology_POINT] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_POINT);

  a2iEntCount[iMesh::EntityType_EDGE][iMesh::EntityTopology_LINE_SEGMENT] =
    a2iEntCount[iMesh::EntityType_ALL_TYPES]
      [iMesh::EntityTopology_LINE_SEGMENT] =
    a2iEntCount[iMesh::EntityType_EDGE]
      [iMesh::EntityTopology_ALL_TOPOLOGIES] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_LINE_SEGMENT);

  a2iEntCount[iMesh::EntityType_FACE][iMesh::EntityTopology_TRIANGLE] =
    a2iEntCount[iMesh::EntityType_ALL_TYPES]
      [iMesh::EntityTopology_TRIANGLE] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_TRIANGLE);

  a2iEntCount[iMesh::EntityType_FACE][iMesh::EntityTopology_QUADRILATERAL] =
    a2iEntCount[iMesh::EntityType_ALL_TYPES]
      [iMesh::EntityTopology_QUADRILATERAL] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_QUADRILATERAL);

  a2iEntCount[iMesh::EntityType_ALL_TYPES][iMesh::EntityTopology_POLYGON] =
    a2iEntCount[iMesh::EntityType_FACE]
      [iMesh::EntityTopology_POLYGON] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_POLYGON);

  a2iEntCount[iMesh::EntityType_FACE][iMesh::EntityTopology_ALL_TOPOLOGIES] =
    a2iEntCount[iMesh::EntityType_FACE]
      [iMesh::EntityTopology_TRIANGLE] +
    a2iEntCount[iMesh::EntityType_FACE]
      [iMesh::EntityTopology_QUADRILATERAL] +
  ...
  a2iEntCount[iMesh::EntityType_ALL_TYPES]
      [iMesh::EntityTopology_TETRAHEDRON] =
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_TETRAHEDRON] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_TETRAHEDRON);

  a2iEntCount[iMesh::EntityType_ALL_TYPES][iMesh::EntityTopology_PYRAMID] =
    a2iEntCount[iMesh::EntityType_REGION][iMesh::EntityTopology_PYRAMID] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_PYRAMID);

  a2iEntCount[iMesh::EntityType_ALL_TYPES][iMesh::EntityTopology_PRISM] =
    a2iEntCount[iMesh::EntityType_REGION][iMesh::EntityTopology_PRISM] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_PRISM);

  a2iEntCount[iMesh::EntityType_ALL_TYPES]
      [iMesh::EntityTopology_HEXAHEDRON] =
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_HEXAHEDRON] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_HEXAHEDRON);

  a2iEntCount[iMesh::EntityType_ALL_TYPES]
      [iMesh::EntityTopology_SEPTAHEDRON] =
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_SEPTAHEDRON] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_SEPTAHEDRON);

  a2iEntCount[iMesh::EntityType_ALL_TYPES]
      [iMesh::EntityTopology_POLYHEDRON] =
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_POLYHEDRON] =
    Mesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_POLYHEDRON);
  ...
  a2iEntCount[iMesh::EntityType_REGION]
    ...
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_TETRAHEDRON] +
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_PYRAMID] +
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_PRISM] +
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_HEXAHEDRON] +
    a2iEntCount[iMesh::EntityType_REGION]
      [iMesh::EntityTopology_SEPTAHEDRON] +
  ...
  for (eEType = iMesh::EntityType_VERTEX;
	...
	int iNumEnt;
	Mesh.getEntities(pvRootSet, static_cast<iMesh::EntityType>(eEType),
			 static_cast<iMesh::EntityTopology>(eETopo),
	...
	case iBase::ErrorType_BAD_TYPE_AND_TOPO:
	  ...
	  break;
	case iBase::ErrorType_NOT_SUPPORTED:
	  // This should never occur, according to the spec.
	  cout << "; feasible though unsupported combination; shouldn't return this error." << endl;
	  iNFailed++;
	  break;
	default:
	  cout << endl;
	  cout << "unitTest hit an unknown error: "  << TErr.getErrorType() << endl;
	  TErr.echo("unitTest hit an unknown error! ");
	  TEST(false);
	}
      }
  ...
  try {
    ::sidl::array<void*> saEntHandles;
    int iNumEnt;
    Mesh.getEntities(pvRootSet, iMesh::EntityType_ALL_TYPES,
		     iMesh::EntityTopology_ALL_TOPOLOGIES,
		     saEntHandles, iNumEnt);
    ::sidl::array<double> sadCoords;
    iMesh::StorageOrder SO = iMesh::StorageOrder_UNDETERMINED;
    int iCSize;
    ...
    int iNumVerts = Mesh.getNumOfType(pvRootSet, iMesh::EntityType_VERTEX);
    TEST(iNumVerts == iNumEnt);
    TEST(iCSize == iNumVerts * Mesh.getGeometricDim());
  } catch (iBase::Error TErr) {
    // Should have thrown InvalidEntityType.
    TEST(TErr.getErrorType() == iBase::ErrorType_INVALID_ENTITY_TYPE);
  }
  ...
  int iNV;
  Mesh.getEntities(pvRootSet, iMesh::EntityType_VERTEX,
		   iMesh::EntityTopology_POINT, saVertHandles, iNV);
  int iLoH = saVertHandles.lower(0);

  ::sidl::array<double> sadCoords1, sadCoords2;
  ::sidl::array<int32_t> saiInEntitySet;
  iMesh::StorageOrder SO1 = iMesh::StorageOrder_UNDETERMINED;
  iMesh::StorageOrder SO2 = iMesh::StorageOrder_UNDETERMINED;
  ...
  qOK = ((SO1 == SO2) && (SO1 != iMesh::StorageOrder_UNDETERMINED) &&
  ...
  iMesh::StorageOrder SO3 = iMesh::StorageOrder_BLOCKED;
  if (SO2 == SO3) SO3 = iMesh::StorageOrder_INTERLEAVED;
  ...
  for (iIES = iLoEnt, i = iLoH; i <= iLoH + iNV - 1; i++, iIES++) {
    if (SO1 == iMesh::StorageOrder_BLOCKED) {
  ...
  // in the two instances.
  {
    ...
    sidl::array<double> sadCoords1, sadCoords2;
    sidl::array<iMesh::EntityTopology> saEntTopo;
    int iVertSize, iOffsetSize, iInSet1Size, iCoords1Size, iCoords2Size;
    int iInSet2Size, iOffset2Size, iIndexSize, iEntTopoSize;
    iMesh::StorageOrder SO1, SO2;
    SO1 = SO2 = iMesh::StorageOrder_INTERLEAVED;
    try {
      Mesh.getAdjEntities(pvRootSet, iMesh::EntityType_ALL_TYPES,
			  iMesh::EntityTopology_ALL_TOPOLOGIES,
      ...
      Mesh.getVtxCoordIndex(pvRootSet, iMesh::EntityType_ALL_TYPES,
			    iMesh::EntityTopology_ALL_TOPOLOGIES,
			    iMesh::EntityType_VERTEX,
...
static void vTestEntityInterface(iMesh::Entity& EntMesh)
{
  ...
  for (eEType = iMesh::EntityType_VERTEX;
	...
	EntMesh.getEntities(pvRootSet, static_cast<iMesh::EntityType>(eEType),
			    static_cast<iMesh::EntityTopology>(eETopo),
			    saEntHandles, iNumEnt);
	if (iNumEnt > 0) {
	  ...
	  for (int iEnt = iEntLo; iEnt <= iEntLo + iNumEnt - 1; iEnt++) {
	    ...
	    iMesh::EntityType ETy = EntMesh.getEntType(pEnt);
	    iMesh::EntityTopology ETo = EntMesh.getEntTopo(pEnt);
	    qOK = qOK &&
	      ((ETy == eEType || eEType == iMesh::EntityType_ALL_TYPES)
	       &&
	       (ETo == eETopo ||
		eETopo == iMesh::EntityTopology_ALL_TOPOLOGIES));
	  }
  ...
  cout << " Checking single vertex coordinate retrieval" << endl;
  {
    ...
    EntMesh.getEntities(pvRootSet, iMesh::EntityType_VERTEX,
			iMesh::EntityTopology_POINT, saVtxHandles, iNVerts);
    iMesh::StorageOrder SO = iMesh::StorageOrder_INTERLEAVED;
  ...
  for (eEType = iMesh::EntityType_VERTEX;
	...
	if (iNumEnt > 0) {
	  ...
	  int eAdjType, eLastType = iMesh::EntityType_REGION;
	  for (eAdjType = iMesh::EntityType_VERTEX;
	       eAdjType <= eLastType;
	       eAdjType++) {
	    // Skip any that are identities or unsupported.
	    if (eAdjType == eEType ||
		(a2iAdjTable[eEType][eAdjType] ==
		 iMesh::AdjacencyInfo_UNAVAILABLE))
	      continue;
	    ...
	    EntMesh.getAdjEntities
	      (pvRootSet, static_cast<iMesh::EntityType>(eEType),
	       static_cast<iMesh::EntityTopology>(eETopo),
	       static_cast<iMesh::EntityType>(eAdjType),
	       saAdjEnt, iNumAdj,
	  ...
	  TEST(qOK);
	} // The above block is only executed if there were some entities.
	else {
	  TEST_SKIPPED;
	}
      }
  ...
  for (eEType = iMesh::EntityType_VERTEX;
	...
	EntMesh.getEntities(pvRootSet,
			    static_cast<iMesh::EntityType>(eEType),
			    static_cast<iMesh::EntityTopology>(eETopo),
			    saoEnt, iActualCount);
	...
	} catch (iBase::Error TErr) { // Big try block beginning with initIter
	  switch (TErr.getErrorType()) {
	  case iBase::ErrorType_FAILURE:
	    ...
	    break;
	  case iBase::ErrorType_INVALID_ARGUMENT:
	    // Can happen for 2D meshes requested to iterate over
	    // regions.
	    if (EntMesh.getGeometricDim() == 2 &&
		((eEType == iMesh::EntityType_REGION) ||
		 ((eEType == iMesh::EntityType_ALL_TYPES) &&
		  ((eETopo == iMesh::EntityTopology_POLYHEDRON) ||
		   (eETopo == iMesh::EntityTopology_TETRAHEDRON) ||
		   (eETopo == iMesh::EntityTopology_PYRAMID) ||
		   (eETopo == iMesh::EntityTopology_PRISM) ||
		   (eETopo == iMesh::EntityTopology_HEXAHEDRON) ||
		   (eETopo == iMesh::EntityTopology_SEPTAHEDRON)))))
	      iNPassed++;
	    else {
  ...
  if (a2iAdjTable[1][0] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[0][1] != iMesh::AdjacencyInfo_UNAVAILABLE) {
    cout << "  Edges and verts:";
    vEntityReciprocityTest(EntMesh, iMesh::EntityType_EDGE,
			   iMesh::EntityType_VERTEX);
    vEntityReciprocityTest(EntMesh, iMesh::EntityType_VERTEX,
			   iMesh::EntityType_EDGE);
    cout << endl;
  }

  // Face->vertex
  if (a2iAdjTable[2][0] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[0][2] != iMesh::AdjacencyInfo_UNAVAILABLE) {
    cout << "  Faces and verts:";
    vEntityReciprocityTest(EntMesh, iMesh::EntityType_FACE,
			   iMesh::EntityType_VERTEX);
    vEntityReciprocityTest(EntMesh, iMesh::EntityType_VERTEX,
			   iMesh::EntityType_FACE);
    cout << endl;
  }

  // Region->vertex
  if (a2iAdjTable[3][0] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[0][3] != iMesh::AdjacencyInfo_UNAVAILABLE) {
    cout << "  Regions and verts:";
    vEntityReciprocityTest(EntMesh, iMesh::EntityType_REGION,
			   iMesh::EntityType_VERTEX);
    vEntityReciprocityTest(EntMesh, iMesh::EntityType_VERTEX,
  ...
  // Face->edge
  if (a2iAdjTable[2][1] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[1][2] != iMesh::AdjacencyInfo_UNAVAILABLE) {
  ...
  // Region->edge
  if (a2iAdjTable[3][1] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[1][3] != iMesh::AdjacencyInfo_UNAVAILABLE) {
  ...
  // Region->face
  if (a2iAdjTable[3][2] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[2][3] != iMesh::AdjacencyInfo_UNAVAILABLE) {
  ...
  for (int iType = 0; iType <= 3; iType++) {
    if (a2iAdjTable[iType][iType] != iMesh::AdjacencyInfo_UNAVAILABLE) {
      cout << "  Type: ";
      cout.width(9);
      cout << astrTypes[iType] << endl;
      iMesh::EntityType eType = static_cast<iMesh::EntityType>(iType);
...
static void vTestArrInterface(iMesh::Arr& ArrMesh) {
  bool qOK;
  int eEType;
  int eETopo;
  ...
  for (eEType = iMesh::EntityType_VERTEX;
	...
	::sidl::array<void*> saEntHandles;
	int iNumEnt;
	ArrMesh.getEntities(pvRootSet, static_cast<iMesh::EntityType>(eEType),
			 static_cast<iMesh::EntityTopology>(eETopo),
			 saEntHandles, iNumEnt);
	if (iNumEnt == 0) {
	  TEST_SKIPPED;
	  ...
	  ::sidl::array<iMesh::EntityType> saEType;
	  ::sidl::array<iMesh::EntityTopology> saETopo;
	  ...
	  for (iTopo = iTopoLo, iType = iTypeLo;
	       ...
	       iTopo++, iType++) {
	    iMesh::EntityTopology eTo = saETopo.get(iType);
	    iMesh::EntityType eTy = saEType.get(iType);
	    qOK = qOK && ((eTo == eETopo ||
			   eETopo == iMesh::EntityTopology_ALL_TOPOLOGIES) &&
			  (eTy == eEType ||
			   eEType == iMesh::EntityType_ALL_TYPES));
	  ...
	  TEST(qOK);
	  if (eEType == iMesh::EntityType_ALL_TYPES)
	    continue;
	  ...
	  TEST(qOK);
	} // Done with the actual test here...
      }
    }
  ...
  for (eEType = iMesh::EntityType_VERTEX;
	...
	(pvRootSet, static_cast<iMesh::EntityTopology>(eETopo));
      void* aEnt[iMaxCount];
      sidl::array<void*> saoEnt;
      int iLo = 0, iHi = iMaxCount-1, iStride = 1;
      saoEnt.borrow(aEnt, 1, &iLo, &iHi, &iStride);
  ...
  if (a2iAdjTable[1][0] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[0][1] != iMesh::AdjacencyInfo_UNAVAILABLE) {
    cout << "  Edges and verts:";
    vArrayReciprocityTest(ArrMesh, iMesh::EntityType_EDGE,
			   iMesh::EntityType_VERTEX);
    vArrayReciprocityTest(ArrMesh, iMesh::EntityType_VERTEX,
			   iMesh::EntityType_EDGE);
    cout << endl;
  }
  ...
  if (a2iAdjTable[2][0] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[0][2] != iMesh::AdjacencyInfo_UNAVAILABLE) {
    cout << "  Faces and verts:";
    vArrayReciprocityTest(ArrMesh, iMesh::EntityType_FACE,
			   iMesh::EntityType_VERTEX);
    vArrayReciprocityTest(ArrMesh, iMesh::EntityType_VERTEX,
			   iMesh::EntityType_FACE);
    cout << endl;
  ...
  if (a2iAdjTable[3][0] != iMesh::AdjacencyInfo_UNAVAILABLE &&
      a2iAdjTable[0][3] != iMesh::AdjacencyInfo_UNAVAILABLE) {
    cout << "  Regions and verts:";
    vArrayReciprocityTest(ArrMesh, iMesh::EntityType_REGION,
			   iMesh::EntityType_VERTEX);
    vArrayReciprocityTest(ArrMesh, iMesh::EntityType_VERTEX,
			   iMesh::EntityType_REGION);
    cout << endl;
...
static void vTestModifyInterface(iMesh::Modify& ModMesh)
{
...

  {
    ...
    ModMesh.getEntities(pvRootSet, iMesh::EntityType_VERTEX,
			iMesh::EntityTopology_POINT, saVerts, iNVerts);
	...
	try {
	  ...
	  TEST(TErr.getErrorType() == iBase::ErrorType_INVALID_ARGUMENT);
	}
  ...
  // coordinates are returned properly.
  {
    ...
    int iNVerts2;
    ModMesh.getEntities(pvRootSet, iMesh::EntityType_VERTEX,
			iMesh::EntityTopology_POINT, saVerts2, iNVerts2);
    ...
    TEST(ModMesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_POINT)
  ...
  // iMesh::Mesh must support Modify, or we wouldn't even be in
  // this subroutine.
  iMesh::Mesh icMesh = iMesh_SIDL::MeshSidl::newMesh(CREATE_ARG);
  iMesh::Modify modMesh(icMesh);
  iMesh::Entity entMesh(icMesh);
  ...
  if (iGeomDim == 2) {
	...
	// edges from verts.
	modMesh.createEnt(iMesh::EntityTopology_LINE_SEGMENT,
			 saVerts, 2, aNewEdges[iE], CStat);
	qOK = qOK && (CStat == iMesh::CreationStatus_NEW);
	// Check that the edge has the right verts
	{
	  ...
	  entMesh.getEntAdj(aNewEdges[iE], iMesh::EntityType_VERTEX, saVertsCheck, iNV);
	  qOK = qOK && ((iNV == 2) &&
	...
	try {
	  ...
	  qOK = qOK && ((CStat == iMesh::CreationStatus_ALREADY_EXISTED) ||
			(CStat == iMesh::CreationStatus_CREATED_DUPLICATE));
	} SHOULD_NOT_THROW;
      }
      cout << endl;
      TEST(qOK);
	...
	for (int iTri = 0; iTri < 2; iTri++) {
	  ...
	  modMesh.createEnt(iMesh::EntityTopology_TRIANGLE,
	  ...
	  // Check that the tri has the right edges
	  {
	    ...
	    entMesh.getEntAdj(aNewTris[iTri], iMesh::EntityType_EDGE, saEdgesCheck, iNE);
	...
	// Verify edge-to-tri connectivity.
	{
	  ...
	  int iNumTri;
	  entMesh.getEntAdj(aNewEdges[10], iMesh::EntityType_FACE, saTri, iNumTri);
	  qOK = qOK && (iNumTri == 2)
	...
	qTriOK = false;
	if (TErr.getErrorType() == iBase::ErrorType_NOT_SUPPORTED) {
	  cout << endl
	...
	for (int iQuad = 0; iQuad < 2; iQuad++) {
	  ...
	  modMesh.createEnt(iMesh::EntityTopology_QUADRILATERAL,
	  ...
	  // Check that the quad has the right edges
	  {
	    ...
	    int iNE;
	    saEdgesCheck.borrow(aEdgesCheck, 1, &iLo, &iHi, &iStride);
	    entMesh.getEntAdj(aNewQuads[iQuad], iMesh::EntityType_EDGE, saEdgesCheck, iNE);
	...
	// Verify edge-to-quad connectivity.
	{
	  ...
	  int iNumQuad;
	  entMesh.getEntAdj(aNewEdges[2], iMesh::EntityType_FACE, saQuad, iNumQuad);
	  qOK = qOK && (iNumQuad == 2)
	...
	if (qTriOK) {
	  ...
	  int iNumFace;
	  entMesh.getEntAdj(aNewEdges[1], iMesh::EntityType_FACE, saFace, iNumFace);
	  qOK = qOK && (iNumFace == 2)
	...
	(pvLocalRootSet, iMesh::EntityTopology_POINT);
      int iNEdges = icMesh.getNumOfTopo
	(pvLocalRootSet, iMesh::EntityTopology_LINE_SEGMENT);
      int iNTris = icMesh.getNumOfTopo
	(pvLocalRootSet, iMesh::EntityTopology_TRIANGLE);
      int iNQuads = icMesh.getNumOfTopo
	(pvLocalRootSet, iMesh::EntityTopology_QUADRILATERAL);
	...
	int iNQuadAfter;
	entMesh.getEntities(pvLocalRootSet, iMesh::EntityType_FACE,
			   iMesh::EntityTopology_QUADRILATERAL,
			     saQuads, iNQuadAfter);
	TEST(iNQuadAfter == 1 &&
	...
	TEST(iNTriAfter == 1 &&
      ...
      TEST(icMesh.getNumOfTopo(pvLocalRootSet,
				   iMesh::EntityTopology_QUADRILATERAL) == 0
	   && icMesh.getNumOfTopo(pvLocalRootSet,
				      iMesh::EntityTopology_TRIANGLE) == 0
	   && icMesh.getNumOfType(pvLocalRootSet,
				  iMesh::EntityType_FACE) == 0);
	...
	sidl::array<void*> saEdges;
	int iNEdgeAfter;
	entMesh.getEntities(pvLocalRootSet, iMesh::EntityType_EDGE,
			   iMesh::EntityTopology_LINE_SEGMENT,
			   saEdges, iNEdgeAfter);
	TEST(iNEdgeAfter == 10 &&
	     icMesh.getNumOfTopo(pvLocalRootSet,
	...
	modMesh.deleteEnt(aNewEdges[i]);
      ...
      TEST(icMesh.getNumOfTopo(pvLocalRootSet,
				   iMesh::EntityTopology_LINE_SEGMENT) == 0 &&
	   icMesh.getNumOfType(pvLocalRootSet,
			       iMesh::EntityType_EDGE) == 0);
	...
	modMesh.deleteEnt(aNewVerts[i]);
      ...
      TEST(icMesh.getNumOfTopo(pvLocalRootSet,
				   iMesh::EntityTopology_POINT) == 0 &&
	   icMesh.getNumOfType(pvLocalRootSet,
			       iMesh::EntityType_VERTEX) == 0);
	...
	// Check that the tri has the right verts
	{
	  ...
	  int iNE;
	  saVertsCheck.borrow(aVertsCheck, 1, &iLo, &iHi, &iStride);
	  entMesh.getEntAdj(aNewTris[iTri], iMesh::EntityType_VERTEX,
			   saVertsCheck, iNE);
	  // Must be in cyclic order, so only three possibilities exist.
	  qOK = qOK && ((iNE == 3) &&
	...
	try {
      ...
      TEST(5 == icMesh.getNumOfType(pvLocalRootSet, iMesh::EntityType_EDGE));
    } catch (iBase::Error& TErr) {
      qTriOK = false;
      if (TErr.getErrorType() == iBase::ErrorType_NOT_SUPPORTED) {
	cout << endl
	...
	// Check that the quad has the right verts
	{
	  ...
	  int iNE;
	  saVertsCheck.borrow(aVertsCheck, 1, &iLo, &iHi, &iStride);
	  entMesh.getEntAdj(aNewQuads[iQuad], iMesh::EntityType_VERTEX,
			   saVertsCheck, iNE);
	  // Must be in cyclic order, so only three possibilities exist.
	  qOK = qOK && ((iNE == 4) &&
	...
	try {
      ...
      TEST((qTriOK &&
	    11 == icMesh.getNumOfType(pvLocalRootSet, iMesh::EntityType_EDGE))
	   ||
	   (!qTriOK &&
	    7 == icMesh.getNumOfType(pvLocalRootSet, iMesh::EntityType_EDGE))
	   );
    } catch (iBase::Error& TErr) {
      qQuadOK = false;
      if (TErr.getErrorType() == iBase::ErrorType_NOT_SUPPORTED) {
...
static void vTestArrModInterface(iMesh::ArrMod& ArrModMesh)
{
  // setVtxArrCoords is trivial to test:  get vertices, change their coords,
  // and verify that the change worked.
  sidl::array<void*> saVerts;
  int iNVerts;
  ArrModMesh.getEntities(pvRootSet, iMesh::EntityType_VERTEX,
			 iMesh::EntityTopology_POINT, saVerts, iNVerts);
  TEST(iNVerts == ArrModMesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_POINT));
  ...
  // and coordinates are returned properly .
  {
    ...
    int iNumNewVerts;
    iMesh::StorageOrder SO = iMesh::StorageOrder_INTERLEAVED;
    ArrModMesh.createVtxArr(10, iMesh::StorageOrder_INTERLEAVED, sadCoords2,
    ...
    TEST(ArrModMesh.getNumOfTopo(pvRootSet, iMesh::EntityTopology_POINT)
	 == iNVerts);
  } // Done checking array vertex creation
}


static void vTestEntSetInterface(iMesh::Mesh& M)
{
  ...
  try {
    ...
    EntMesh.initEntIter( pvRootSet, iMesh::EntityType_FACE,
			 iMesh::EntityTopology_ALL_TOPOLOGIES, pvIter);
    for ( i=0; i<10; i++ ) {
...
#warning These error tests require a factory.
//   if ( qErrTests ) {
...
//     // entity handle.
//     iMesh::Mesh ES = iMesh::MeshSidl::newMesh(CREATE_ARG);
//     try {
//       ES.createEntSet( true, apvEntSets[10] );
//       cout << "\nERROR: Exception not thrown when trying to create an "
// 	   << "entity set for a mesh with no data! ";
//       TEST ( error_throwing );
//     } MUST_THROW ( iBase::ErrorType_NO_DATA );
//     try {
//       ES.createEntSet( false, apvEntSets[10] );
//       cout << "\nERROR: Exception not thrown when trying to create an "
// 	   << "entity set for a mesh with no data! ";
//       TEST ( error_throwing );
//     } MUST_THROW ( iBase::ErrorType_NO_DATA );
//     try {
//       ES.destroyEntSet( apvEntSets[10] );
//       cout << "\nERROR: Exception not thrown when trying to create an "
// 	   << "entity set for a mesh with no data! ";
//       TEST ( error_throwing );
//     } MUST_THROW ( iBase::ErrorType_NO_DATA );
//     try {
//       ES.getNumEntSets( pvRootSet, 0 );
//       cout << "\nERROR: Exception not thrown when trying to create an "
// 	   << "entity set for a mesh with no data! ";
//       TEST ( error_throwing );
//     } MUST_THROW ( iBase::ErrorType_NO_DATA );
...
// 	   << "entity set! ";
//       TEST ( error_throwing );
//     } MUST_THROW ( iBase::ErrorType_INVALID_ENTITYSET_HANDLE );
//     try {
//       ES.isList( apvEnts[0] );
...
// 	   << "to an entity set! ";
//       TEST ( error_throwing );
//     } MUST_THROW ( iBase::ErrorType_INVALID_ENTITY_HANDLE );
//     try {
...
// 	   << "to the root set! ";
//       TEST ( error_throwing );
//     } MUST_THROW ( iBase::ErrorType_INVALID_ARGUMENT );
//     try {
...
static void vTestSetRelationInterface(iBase::SetRelation& SR)
{
...
static void vTestBoolOpsInterface(iMesh::Mesh& M)
{
  cout << "Testing methods with regular sets and lists...\n";
  iBase::SetBoolOps BO(M);
  iMesh::Entity EntMesh(M);
  void* apvSets[10];
  void* apvEnts[10];
  void* pvIter;
  ...
  try {
    ...
    M.getEntities( apvSets[7], iMesh::EntityType_ALL_TYPES,
		    iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
    void **ppvGotEnts;
    if ( iNumEnts == 2 ) {
      qGotAllItems = true;
    ...
    if ( iNumSets == 4 )
      GOT_ALL_ITEMS ( (apvSets+2), saGotSets, 4, qGotAllItems );
    TEST ( qGotAllItems );
    M.getEntities( apvSets[8], iMesh::EntityType_ALL_TYPES,
		    iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
    if ( iNumEnts == 2 ) {
      qGotAllItems = true;
      ppvGotEnts = saGotEnts.first();
    ...
    M.getEntities( apvSets[9], iMesh::EntityType_ALL_TYPES,
		    iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
    if ( iNumEnts == 2 ) {
      qGotAllItems = true;
      ppvGotEnts = saGotEnts.first();
  ...
  try {
    ...
    sidl::array<void*> saGotEnts;
    void **ppvGotEnts;
    M.getEntities( apvSets[6], iMesh::EntityType_ALL_TYPES,
		    iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
    if ( iNumEnts == 10 ) {
      qGotAllItems = true;
      ppvGotEnts = saGotEnts.first();
  ...
  try {
    ...
    M.getEntities( apvSets[7], iMesh::EntityType_ALL_TYPES,
		    iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
    int iNumAllEnts = M.getNumOfType(pvRootSet, iMesh::EntityType_VERTEX) +
      M.getNumOfType(pvRootSet, iMesh::EntityType_EDGE) +
      M.getNumOfType(pvRootSet, iMesh::EntityType_FACE) +
      M.getNumOfType(pvRootSet, iMesh::EntityType_REGION);
    void** ppvGotEnts;
  ...
  try {
    ...
    M.getEntities( pvRootSet, iMesh::EntityType_ALL_TYPES,
		    iMesh::EntityTopology_ALL_TOPOLOGIES, saAllEnts, iNumAllEnts );
    qGotAllItems = false;
...
static void vTestMeshWithSets(iMesh::Mesh& M)
{
  ...
  iMesh::Arr ArrMesh(M);
  iBase::EntSet ES(M);
  const int iNumType = iMesh::EntityType_ALL_TYPES - iMesh::EntityType_VERTEX;
  const int iNumTopo = iMesh::EntityTopology_ALL_TOPOLOGIES - iMesh::EntityTopology_POINT;
  void* apvSets[5];
  ...
  try {
    ...
    for ( i = 0; i < iNumType; i++ ) {
      if ( (iGeoDim == 2) && (i > iMesh::EntityType_FACE) )
	break;
      EntMesh.initEntIter(pvRootSet,
			  static_cast<iMesh::EntityType>
			  (i+iMesh::EntityType_VERTEX),
			  iMesh::EntityTopology_ALL_TOPOLOGIES, pvIter);
    ...
    for ( i = 0; i < iNumTopo; i++ ) {
      if ( (iGeoDim == 2) && (i > iMesh::EntityTopology_QUADRILATERAL) )
	break;
      EntMesh.initEntIter(pvRootSet, iMesh::EntityType_ALL_TYPES,
			  static_cast<iMesh::EntityTopology>(i+iMesh::EntityTopology_POINT), pvIter);
  ...
  try {
    ...
    qNumOK0 = qNumOK0 && ( M.getNumOfType(apvSets[0], iMesh::EntityType_VERTEX) == 0 );
    qNumOK1 = qNumOK1 && ( M.getNumOfType(apvSets[1], iMesh::EntityType_VERTEX)
			   == 2*aiNumTypeEnts[0] );
    qNumOK3 = qNumOK3 && ( M.getNumOfType(apvSets[3], iMesh::EntityType_VERTEX)
			   == aiNumTypeEnts[0] );
    for ( int iType = iMesh::EntityType_VERTEX+1;
	  iType < iMesh::EntityType_ALL_TYPES; iType++ ) {
      if ( (iGeoDim == 2) && (iType > iMesh::EntityType_FACE) )
	break;
      qNumOK0 = qNumOK0 && ( M.getNumOfType(apvSets[0], static_cast<iMesh::EntityType>(iType))
			     == 0 );
      qNumOK1 = qNumOK1 && ( M.getNumOfType(apvSets[1], static_cast<iMesh::EntityType>(iType))
			     == aiNumTypeEnts[iType-iMesh::EntityType_VERTEX] );
      qNumOK3 = qNumOK3 && ( M.getNumOfType(apvSets[3], static_cast<iMesh::EntityType>(iType))
			     == aiNumTypeEnts[iType-iMesh::EntityType_VERTEX] );
    }
    // The points have to be handled separately because they were added twice to the list
    qNumOK0 = qNumOK0 && ( M.getNumOfTopo(apvSets[0], iMesh::EntityTopology_POINT) == 0 );
    qNumOK2 = qNumOK2 && ( M.getNumOfTopo(apvSets[2], iMesh::EntityTopology_POINT)
			   == 2*aiNumTopoEnts[0] );
    qNumOK4 = qNumOK4 && ( M.getNumOfTopo(apvSets[4], iMesh::EntityTopology_POINT)
			   == aiNumTopoEnts[0] );
    for ( int iTopo = iMesh::EntityTopology_POINT+1;
	  iTopo < iMesh::EntityTopology_ALL_TOPOLOGIES; iTopo++ ) {
      if ( (iGeoDim == 2) && (i > iMesh::EntityTopology_QUADRILATERAL) )
	break;
      qNumOK0 = qNumOK0 && ( M.getNumOfTopo(apvSets[0], static_cast<iMesh::EntityTopology>(iTopo))
			     == 0 );
      qNumOK2 = qNumOK2 && ( M.getNumOfTopo(apvSets[2], static_cast<iMesh::EntityTopology>(iTopo))
			     == aiNumTopoEnts[iTopo-iMesh::EntityTopology_POINT] );
      qNumOK4 = qNumOK4 && ( M.getNumOfTopo(apvSets[4], static_cast<iMesh::EntityTopology>(iTopo))
			     == aiNumTopoEnts[iTopo-iMesh::EntityTopology_POINT] );
    }
    TEST ( qNumOK0 );
    TEST ( qNumOK1 );
  ...
  try {
    ...
    // Set #0 is empty
    M.getEntities( apvSets[0], iMesh::EntityType_VERTEX,
			iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
    TEST ( iNumEnts == 0 );
    // List #1 has double the vertices
    saGotEnts = saGotEnts.create1d( 2*aiNumTypeEnts[0] );
    M.getEntities( apvSets[1], iMesh::EntityType_VERTEX,
			iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
    ...
    qGotData = false;
    M.getEntities( apvSets[3], iMesh::EntityType_VERTEX,
			iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
    ...
    for ( int iType = 1; iType < iNumType; iType++ ) {
      if ( (iGeoDim == 2) && (i > iMesh::EntityType_FACE) )
	break;
      M.getEntities( apvSets[0], static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			  iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
      TEST ( iNumEnts == 0 );
      saGotEnts = saGotEnts.create1d( aiNumTypeEnts[iType] );
      M.getEntities( apvSets[1], static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			  iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
	...
	qGotData = false;
      TEST ( qGotData );
      qGotData = false;
      M.getEntities( apvSets[3], static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			  iMesh::EntityTopology_ALL_TOPOLOGIES, saGotEnts, iNumEnts );
      if ( iNumEnts == aiNumTypeEnts[iType] )
    ...
    M.getEntities( apvSets[0], iMesh::EntityType_ALL_TYPES,
			iMesh::EntityTopology_POINT, saGotEnts, iNumEnts );
    TEST ( iNumEnts == 0 );
    saGotEnts = saGotEnts.create1d( 2*aiNumTopoEnts[0] );
    M.getEntities( apvSets[2], iMesh::EntityType_ALL_TYPES ,
			iMesh::EntityTopology_POINT, saGotEnts, iNumEnts );
    ...
    TEST ( qGotData );
    qGotData = false;
    M.getEntities( apvSets[4], iMesh::EntityType_ALL_TYPES,
			iMesh::EntityTopology_POINT, saGotEnts, iNumEnts );
    ...
    for ( int iTopo = 1; iTopo < iNumTopo; iTopo++ ) {
      if ( (iGeoDim == 2) && (iTopo > iMesh::EntityTopology_QUADRILATERAL) )
	break;
      M.getEntities( apvSets[0], iMesh::EntityType_ALL_TYPES,
			  static_cast<iMesh::EntityTopology>(iTopo+iMesh::EntityTopology_POINT),
			  saGotEnts, iNumEnts );
      TEST ( iNumEnts == 0 );
  ...
  try {
    for ( int eEType = iMesh::EntityType_VERTEX;
	  eEType < iMesh::EntityType_ALL_TYPES; eEType++ ) {
      for ( int eETopo = iMesh::EntityTopology_POINT;
	    eETopo < iMesh::EntityTopology_ALL_TOPOLOGIES; eETopo++ ) {
	if ( a2qLegalTypeAndTopo[eEType][eETopo] ) {
	  if ( (iGeoDim == 2) && (eEType > iMesh::EntityType_FACE ||
				  eETopo > iMesh::EntityTopology_QUADRILATERAL) )
	    continue;
	  // Get entities of the current type and topology
	  ::sidl::array<void*> saEntHandles;
	  int iNumEnt;
	  M.getEntities( apvSets[2], static_cast<iMesh::EntityType>(eEType),
			      static_cast<iMesh::EntityTopology>(eETopo),
			      saEntHandles, iNumEnt );
	  if ( iNumEnt == 0 )
	    continue;
	  ...
	  // Now test for equivalence in adjacency operations.
	  int eAdjType, eLastType = iMesh::EntityType_REGION;
	  for ( eAdjType = iMesh::EntityType_VERTEX; eAdjType <= eLastType; eAdjType++ ) {
	    // Skip any that are unsupported.
	    if ( a2iAdjTable[eEType][eAdjType] == iMesh::AdjacencyInfo_UNAVAILABLE )
	      continue;
	    qAdjCons = true;
	    qInCons = true;
	    ...
	    M.getAdjEntities( apvSets[2], static_cast<iMesh::EntityType>(eEType),
				   static_cast<iMesh::EntityTopology>(eETopo),
				   static_cast<iMesh::EntityType>(eAdjType), saAdjEnt,
		...
		int iNLocalAdj;
		sidl::array<void*> saAdjEntHandles;
		EntMesh.getEntAdj( apvEnts[iEnt], static_cast<iMesh::EntityType>(eAdjType),
				  saAdjEntHandles, iNLocalAdj );
		// Number of adjacencies must match.
  ...
  iMesh::StorageOrder SOTemp;
  try {
    qStorCons = true;
    for ( int iSet = 0; iSet < 5 && qStorCons; iSet++ ) {
      sidl::array<int> saiInSet1;
      sidl::array<double> sadAllCoords;
      SOTemp = iMesh::StorageOrder_UNDETERMINED;
	...
	for ( int eETopo = iMesh::EntityTopology_POINT;
	  ...
	  if ( !a2qLegalTypeAndTopo[eEType][eETopo] )
	    continue;
	  if ( (iGeoDim == 2) && (eEType == iMesh::EntityType_REGION ||
				  (eETopo > iMesh::EntityTopology_QUADRILATERAL &&
				   eETopo != iMesh::EntityTopology_ALL_TOPOLOGIES)) )
	    continue;

	  for ( int eAdjType = iMesh::EntityType_VERTEX;
		eAdjType < iMesh::EntityType_ALL_TYPES; eAdjType++ ) {
	    // Skip any that are identities or unsupported.
	    if ( eEType == eAdjType ||
		 a2iAdjTable[eEType][eAdjType] == iMesh::AdjacencyInfo_UNAVAILABLE )
	      continue;

	    sidl::array<void*> saAdjEnts;
	    sidl::array<int> saiOffsets1, saiInSet2;
	    M.getAdjEntities( apvSets[iSet], static_cast<iMesh::EntityType>(eEType),
				   static_cast<iMesh::EntityTopology>(eETopo),
				   static_cast<iMesh::EntityType>(eAdjType), saAdjEnts,
	    ...
	    if ( eAdjType == iMesh::EntityType_VERTEX ) {
	      saVerts = saAdjEnts;
	      iNumVerts = iNumAdjEnts;
	    }
	    else {
	      ArrMesh.getEntArrAdj( saAdjEnts, iNumAdjEnts, iMesh::EntityType_VERTEX,
	    ...
	    sidl::array<iMesh::EntityTopology> saTopologies;
	    M.getVtxCoordIndex( apvSets[iSet], static_cast<iMesh::EntityType>(eEType),
				     static_cast<iMesh::EntityTopology>(eETopo),
				     static_cast<iMesh::EntityType>(eAdjType), saiOffsets3,
	    ...
	    if ( (iNumOffsets3 == iNumAdjEnts+1 ) && (iNumVerts == iNumIndices) &&
		 (iNumCoords == iGeoDim*iNumVerts) ) {
	      ...
	      if ( SOTemp == iMesh::StorageOrder_BLOCKED )
  ...
  if ( qErrTests ) {
    ...
    // entity handle.
    try {
      M.getNumOfType( pvBadSet, iMesh::EntityType_VERTEX  );
      cout << "\nERROR: Exception not thrown when getting number of a type for "
	   << "an invalid entity set handle! ";
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_ENTITYSET_HANDLE );
    try {
      M.getNumOfType( apvSets[0], iMesh::EntityType_ALL_TYPES );
      cout << "\nERROR: Exception not thrown when getting number of a type for "
	   << "all entity types! ";
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_ENTITY_TYPE );
    try {
      M.getNumOfType( apvSets[0], static_cast<iMesh::EntityType>(iMesh::EntityType_ALL_TYPES+1) );
      cout << "\nERROR: Exception not thrown when getting number of a type for "
	   << "an invalid entity topology! ";
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_ENTITY_TYPE );
    try {
      M.getNumOfTopo( pvBadSet, iMesh::EntityTopology_POINT  );
      cout << "\nERROR: Exception not thrown when getting number of a topology for "
	   << "an invalid entity set handle! ";
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_ENTITYSET_HANDLE );
    try {
      M.getNumOfTopo( apvSets[0], iMesh::EntityTopology_ALL_TOPOLOGIES );
      cout << "\nERROR: Exception not thrown when getting number of a topolgy for "
	   << "all entity topologies! ";
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_ENTITY_TOPOLOGY );
    try {
      M.getNumOfTopo( apvSets[0],
			   static_cast<iMesh::EntityTopology>(iMesh::EntityTopology_ALL_TOPOLOGIES+1) );
      cout << "\nERROR: Exception not thrown when getting number of a topolgy for "
	   << "an invalid entity topology! ";
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_ENTITY_TOPOLOGY );
    ...
    iMesh::StorageOrder SOTemp = iMesh::StorageOrder_INTERLEAVED;
    try {
    ...
    sidl::array<iMesh::EntityTopology> saGotTopo;
    int iNumOffsets, iNumGotTopo;
    try {
      EntMesh.getVtxCoordIndex( pvBadSet, iMesh::EntityType_VERTEX, iMesh::EntityTopology_POINT,
			       iMesh::EntityType_VERTEX, saOffsets, iNumOffsets, saIndices,
	...
	if ( a2qLegalTypeAndTopo[eEType][eETopo] ) {
	  ...
	  */
	  ...
	  try {
	    ...
	    M.getAdjEntities( apvSets[2], static_cast<iMesh::EntityType>(eEType),
				   static_cast<iMesh::EntityTopology>(eETopo),
				   iMesh::EntityType_VERTEX, saAdjEnt,
				   iNumAdj, saiOffset, iOffsetSize, saiInSet, iInSetSize );
	    cout << "\nERROR: Exception not thrown when getting adjacent entities for "
		 << "an invalid entity \n       type-topology combination ("
		 << astrTypes[eEType] << " with " << astrTopologies[eETopo] << ")! ";
	    TEST ( error_throwing );
	  } MUST_THROW ( iBase::ErrorType_BAD_TYPE_AND_TOPO );
	  ...
	  try {
	    M.getVtxCoordIndex( apvSets[2], static_cast<iMesh::EntityType>(eEType),
				     static_cast<iMesh::EntityTopology>(eETopo),
				     iMesh::EntityType_VERTEX, saOffsets, iNumOffsets, saIndices,
				     iNumIndices, saGotTopo, iNumGotTopo );
...
static void vTestEntityWithSets(iMesh::Mesh& M)
{
  //    initEntIter, getNextEntIter, resetEntIter, endEntIter
  iMesh::Entity EntMesh(M);
  iBase::EntSet ES(M);
  ...
  try {
    ...
    for ( i = 0; i < iNumType; i++ ) {
      if ( (iGeoDim == 2) && (i > iMesh::EntityType_FACE) )
	break;
      EntMesh.initEntIter(pvRootSet, static_cast<iMesh::EntityType>(i+iMesh::EntityType_VERTEX),
			  iMesh::EntityTopology_ALL_TOPOLOGIES, pvIter);
      int &j = aiNumTypeEnts[i];
      while ( j < 5*(iNumType-i) && EntMesh.getNextEntIter(pvIter, a2pvTypeEnts[i][j]) )
	j++;
  ...
  try {
    for ( int iType = 0; iType < iNumType; iType++ ) {
      if ( (iGeoDim == 2) && (iType > iMesh::EntityType_FACE) )
	break;
      EntMesh.initEntIter(apvSets[0], static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			  iMesh::EntityTopology_ALL_TOPOLOGIES, apvTypeIter0[iType]);
      EntMesh.initEntIter( apvSets[1],
			   static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			   iMesh::EntityTopology_ALL_TOPOLOGIES, apvTypeIter1[iType] );
      EntMesh.initEntIter( apvSets[3],
			   static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			   iMesh::EntityTopology_ALL_TOPOLOGIES, apvTypeIter3[iType] );
    }
    for ( int iTopo = 0; iTopo < iNumTopo; iTopo++ ) {
      if ( (iGeoDim == 2) && (iTopo > iMesh::EntityTopology_QUADRILATERAL) )
	break;
      EntMesh.initEntIter(apvSets[0], iMesh::EntityType_ALL_TYPES,
			  static_cast<iMesh::EntityTopology>(iTopo+iMesh::EntityTopology_POINT),
			  apvTopoIter0[iTopo]);
      EntMesh.initEntIter( apvSets[2], iMesh::EntityType_ALL_TYPES,
			   static_cast<iMesh::EntityTopology>(iTopo+iMesh::EntityTopology_POINT),
			   apvTopoIter2[iTopo] );
      EntMesh.initEntIter( apvSets[4], iMesh::EntityType_ALL_TYPES,
			   static_cast<iMesh::EntityTopology>(iTopo+iMesh::EntityTopology_POINT),
			     apvTopoIter4[iTopo] );
    }
  } SHOULD_NOT_THROW;
  ...
  try {
    ...
    i = 0;
    while ( EntMesh.getNextEntIter(apvTypeIter1[0], pvEntTemp) )
      i++;
    TEST(i == iNumTypeVerts);
    // The following code is for iterators with modification, and the behavior it requires is not mandated by the spec.
//     pvEntOut = pvEntTemp;
...
//       TEST ( false );
    ...
    for ( int iType = 1; iType < iNumType; iType++ ) {
      ...
      i = 0;
      while ( EntMesh.getNextEntIter(apvTypeIter1[iType], pvEntTemp) )
	i++;
      TEST(i == aiNumTypeEnts[iType]);
      // The following code is for iterators with modification, and the behavior it requires is not mandated by the spec.
//       pvEntOut = pvEntTemp;
...
//       TEST ( i >= aiNumTypeEnts[iType]/2 );
      TEST ( !EntMesh.getNextEntIter(apvTypeIter3[iType], pvEntTemp) );
    }
    EntMesh.resetEntIter( apvTopoIter2[0] );
    i = 0;
    while ( EntMesh.getNextEntIter(apvTopoIter2[0], pvEntTemp) )
      i++;
    pvEntOut = pvEntTemp;
    while ( i < (iNumTopoVerts/2) && EntMesh.getNextEntIter(apvTopoIter2[0], pvEntTemp) )
      i++;
    TEST(i == iNumTopoVerts);
    // The following code is for iterators with modification, and the behavior it requires is not mandated by the spec.
...
//       TEST ( false );
    ...
    for ( int iTopo = 1; iTopo < iNumTopo; iTopo++ ) {
      ...
      i = 0;
      while ( EntMesh.getNextEntIter(apvTopoIter2[iTopo], pvEntTemp) )
	i++;
      TEST(i == aiNumTopoEnts[iTopo]);
      // The following code is for iterators with modification, and the behavior it requires is not mandated by the spec.
//       pvEntOut = pvEntTemp;
...
// 	i++;
//       }
      TEST ( !EntMesh.getNextEntIter(apvTopoIter4[iTopo], pvEntTemp) );
    }
  } SHOULD_NOT_THROW;
  cout << "DONE\n";
  ...
  if ( qErrTests ) {
    ...
    // entity handle.
    try {
      EntMesh.initEntIter( pvBadSet, iMesh::EntityType_VERTEX,
			   iMesh::EntityTopology_ALL_TOPOLOGIES, pvBadIter );
    ...
    try {
      EntMesh.initEntIter( apvSets[0], static_cast<iMesh::EntityType>(iMesh::EntityType_ALL_TYPES+1),
			   iMesh::EntityTopology_ALL_TOPOLOGIES, pvBadIter );
      cout << "\nERROR: Exception not thrown when initializing an iterator for "
    ...
    for ( int iType = iMesh::EntityType_VERTEX; iType <= iMesh::EntityType_ALL_TYPES; iType++ )
      for ( int iTopo = iMesh::EntityTopology_POINT;
	    iTopo <= iMesh::EntityTopology_ALL_TOPOLOGIES; iTopo++ ) {
	if ( !a2qLegalTypeAndTopo[iType][iTopo] ) {
	  if ( (iGeoDim == 2) && (iType == iMesh::EntityType_REGION ||
				  (iTopo > iMesh::EntityTopology_QUADRILATERAL &&
				   iTopo != iMesh::EntityTopology_ALL_TOPOLOGIES)) )
	    continue;
	  try {
	    EntMesh.initEntIter( apvSets[0], static_cast<iMesh::EntityType>(iType),
				 static_cast<iMesh::EntityTopology>(iTopo), pvBadIter );
	    cout << "\nERROR: Exception not thrown when initializing an iterator for "
		 << "an invalid entity \n       type-topology combination ("
    ...
    try {
      ...
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_ITERATOR_HANDLE );
    try {
...
static void vTestArrayWithSets(iMesh::Mesh& M)
{
  iMesh::Entity EntMesh(M);
  iMesh::Arr    ArrMesh(M);
  iBase::EntSet ES(M);
  ...
  try {
    for ( int iType = 0; iType < iNumType; iType++ ) {
      if ( (iGeoDim == 2) && (iType > iMesh::EntityType_FACE) )
	break;
      ArrMesh.initEntArrIter(apvSets[0],
			     static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			     iMesh::EntityTopology_ALL_TOPOLOGIES, 2, apvTypeIter0[iType]);
      ArrMesh.initEntArrIter( apvSets[1],
			      static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			      iMesh::EntityTopology_ALL_TOPOLOGIES, 2, apvTypeIter1[iType] );
      ArrMesh.initEntArrIter( apvSets[3],
			      static_cast<iMesh::EntityType>(iType+iMesh::EntityType_VERTEX),
			      iMesh::EntityTopology_ALL_TOPOLOGIES, 2, apvTypeIter3[iType] );
    }
    for ( int iTopo = 0; iTopo < iNumTopo; iTopo++ ) {
      if ( (iGeoDim == 2) && (iTopo > iMesh::EntityTopology_QUADRILATERAL) )
	break;
      ArrMesh.initEntArrIter(apvSets[0], iMesh::EntityType_ALL_TYPES,
			     static_cast<iMesh::EntityTopology>(iTopo+iMesh::EntityTopology_POINT),
			     2, apvTopoIter0[iTopo]);
      ArrMesh.initEntArrIter( apvSets[2], iMesh::EntityType_ALL_TYPES,
			      static_cast<iMesh::EntityTopology>(iTopo+iMesh::EntityTopology_POINT),
			      2, apvTopoIter2[iTopo] );
      ArrMesh.initEntArrIter( apvSets[4], iMesh::EntityType_ALL_TYPES,
			      static_cast<iMesh::EntityTopology>(iTopo+iMesh::EntityTopology_POINT),
  ...
  try {
    ...
    for ( int iType = 1; iType < iNumType; iType++ ) {
      i = 0;
      while ( ArrMesh.getNextEntArrIter(apvTypeIter1[iType], saEntTemp, iNumEnts) ) {
	ppvGotEnts = saEntTemp.first();
	for ( int j=0; j<iNumEnts; j++ ) {
	  saGotEnts.set( i, ppvGotEnts[j] );
	  i++;
  ...
  try {
    ...
    while (ArrMesh.getNextEntArrIter(apvTypeIter1[0], saEntTemp, iNumEnts) ) {
      for ( int j=0; j<iNumEnts; j++ ) {
	pvEntTemp = saEntTemp.get(j);
	i++;
      }
    }
    // The following code tests iterators with modification in a way
    // that the spec doesn't actually mandate. 
//     pvEntOut = pvEntTemp;
...
//       }
      TEST ( i == aiNumTypeEnts[iType] );
      TEST ( !ArrMesh.getNextEntArrIter(apvTypeIter3[iType], saEntTemp, iNumEnts)
	     && iNumEnts == 0); 
    }
    ...
    while ( ArrMesh.getNextEntArrIter(apvTopoIter2[0], saEntTemp, iNumEnts) ) {
      for ( int j=0; j<iNumEnts; j++ ) {
	pvEntTemp = saEntTemp.get(j);
	i++;
      }
...
//       TEST ( false );
    ...
    for ( int iTopo = 1; iTopo < iNumTopo; iTopo++ ) {
      ...
      while ( ArrMesh.getNextEntArrIter(apvTopoIter2[iTopo], saEntTemp, iNumEnts) )
	for ( int j=0; j<iNumEnts; j++ ) {
	  pvEntTemp = saEntTemp.get(j);
	  i++;
	}
...
//       }
  ...
  if ( qErrTests ) {
    ...
    // entity handle.
    try {
      ArrMesh.initEntArrIter( pvBadSet, iMesh::EntityType_VERTEX,
			      iMesh::EntityTopology_ALL_TOPOLOGIES, 3, pvBadIter );
      cout << "\nERROR: Exception not thrown when initializing an iterator for "
	   << "an invalid entity set handle! ";
      TEST ( error_throwing );
    ...
    try {
      ArrMesh.initEntArrIter( apvSets[0], static_cast<iMesh::EntityType>(iMesh::EntityType_ALL_TYPES+1),
			      iMesh::EntityTopology_ALL_TOPOLOGIES, 3, pvBadIter );
      cout << "\nERROR: Exception not thrown when initializing an iterator for "
	   << "an invalid entity type! ";
      TEST ( error_throwing );
	...
	if ( !a2qLegalTypeAndTopo[iType][iTopo] ) {
	  try {
	    ArrMesh.initEntArrIter( apvSets[0], static_cast<iMesh::EntityType>(iType),
				    static_cast<iMesh::EntityTopology>(iTopo), 3, pvBadIter );
	    cout << "\nERROR: Exception not thrown when initializing an iterator for "
		 << "an invalid entity \n       type-topology combination ("
		 << astrTypes[iType] << " with " << astrTopologies[iTopo] << ")! ";
	    TEST ( error_throwing );
...
static void vTestTagInterface(iBase::Tag& TagMesh)
{
  ...
  if ( qErrTests ) {
    ...
    // entity handle.
    try {
      TagMesh.createTag( astrTagNames[0], 2, iBase::TagValueType_DOUBLE,
			 pvBadTag );
      cout << "\nERROR: Duplicate tag name not caught! ";
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_TAG_ALREADY_EXISTS );
    try {
      TagMesh.createTag( "Bad", -1, iBase::TagValueType_ENTITY_HANDLE,
			 pvBadTag );
      cout << "\nERROR: Invalid tag value size not caught! ";
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_ARGUMENT );
    try {
      TagMesh.createTag( "Bad", 1, iBase::TagValueType(5), pvBadTag );
    ...
    try {
      ...
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_INVALID_TAG_HANDLE );
    try {
    ...
    try {
      ...
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_TAG_NOT_FOUND );
    cout << "DONE\n";
  }
...
static void vTestEntTagInterface(iMesh::Mesh& M)
{
  void* pvIter;
  void* apvTags[7];
  void* apvEnts[3];
...
#undef icMesh
#define icMesh M
    iBase::Tag  Tag2 = icMesh;
    iBase::EntTag ET2 = icMesh;
    try {
      for ( int i=0; i<3; i++ )
    ...
    try {
      ...
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_BAD_ARRAY_SIZE );
	...
	TEST ( error_throwing );
      } MUST_THROW ( iBase::ErrorType_BAD_ARRAY_DIMENSION );
    }
    ...
    try {
      ...
      TEST ( error_throwing );
    } MUST_THROW ( iBase::ErrorType_NIL_ARRAY );
    try {
...
#warning Fix me
  try {
    ...
    TEST ( error_throwing );
  } MUST_THROW ( iBase::ErrorType_TAG_IN_USE );
  try {
...
static void vTestArrTagInterface(iMesh::Mesh& M)
{
...
static void vTestSetTagInterface(iMesh::Mesh& stMesh)
{
  sidl::array<char> saOutput;
  sidl::array<void*> saGotTags;
  void* apvTags[7];
  ...
  iBase::Tag    TagInt(stMesh);
  iBase::SetTag ST(stMesh);
  iBase::EntSet ES(stMesh);
  iMesh::Entity EntMesh(stMesh);
...
//     iMesh::Mesh icMesh = iMesh_SIDL::MeshSidl::newMesh(CREATE_ARG);
#undef icMesh
#define icMesh stMesh
    iBase::EntSet ES2(icMesh);
    iBase::Tag Tag2(icMesh);
    iBase::SetTag ST2(icMesh);
...
int main(int argc, char *argv[] )
{
  ...
  {
    // EVERYTHING in the iMesh interface extends iMesh::Mesh, so this had
    // better work!  Otherwise, this implementation has nothing at all.
    iMesh::Mesh mesh = icMesh;
    TEST(mesh._not_nil());
    if (mesh._is_nil()) {
      cout << "This appears not to be a iMesh implementation.\n";
      return 1;
    }
  ...
  // Test stuff specific to interface Modify.  Those functions are:
  //     setVtxCoords, createVtx, createEnt, deleteEnt
#warning Modify and ArrMod currently disabled.
//   bool qModifyPassed = false;
//   {
//     iMesh::Modify tmMesh = icMesh;
//     if (tmMesh._not_nil()) {
...
//   }
  ...
  //     getChldn, getPrnts
  {
    iBase::SetRelation tsrMesh = icMesh;
    if (tsrMesh._not_nil()) {
  ...
  {
    iBase::SetBoolOps tsboMesh = icMesh;
    iMesh::Entity teMesh = icMesh;
