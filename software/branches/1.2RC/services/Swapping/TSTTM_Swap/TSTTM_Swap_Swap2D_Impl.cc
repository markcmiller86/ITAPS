...
throw ( 
  ...
  ClassMesh.getClas(oCell1, oClass1);
  ClassMesh.getClas(oCell2, oClass2);
  ...
  if (qDoSwap (adCoordsA, adCoordsB, adCoordsC, adCoordsD)) {
    ...
    ClassMesh.setClas(oNewEdge, oClass1);
    ...
    assert(CStat == TSTTM::CreationStatus_NEW);
    ClassMesh.setClas(oNewCellA, oClass1);
    ...
    assert(CStat == TSTTM::CreationStatus_NEW);
    ClassMesh.setClas(oNewCellB, oClass1);
