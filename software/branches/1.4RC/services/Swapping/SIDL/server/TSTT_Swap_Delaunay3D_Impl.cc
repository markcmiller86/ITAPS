// 
// File:          TSTT_Swap_Delaunay3D_Impl.cc
...
void TSTT_Swap::Delaunay3D_impl::_ctor() {
  // DO-NOT-DELETE splicer.begin(TSTT_Swap.Delaunay3D._ctor)
  // No internal state
  // DO-NOT-DELETE splicer.end(TSTT_Swap.Delaunay3D._ctor)
}

// user-defined destructor.
void TSTT_Swap::Delaunay3D_impl::_dtor() {
  // DO-NOT-DELETE splicer.begin(TSTT_Swap.Delaunay3D._dtor)
  // No internal state
  // DO-NOT-DELETE splicer.end(TSTT_Swap.Delaunay3D._dtor)
}

// static class initializer.
void TSTT_Swap::Delaunay3D_impl::_load() {
  // DO-NOT-DELETE splicer.begin(TSTT_Swap.Delaunay3D._load)
  // Insert-Code-Here {TSTT_Swap.Delaunay3D._load} (class initialization)
  // DO-NOT-DELETE splicer.end(TSTT_Swap.Delaunay3D._load)
}
 ...
 */
bool
TSTT_Swap::Delaunay3D_impl::shouldMinimize ()
throw ( 
  ::TSTTB::Error
)
{
  // DO-NOT-DELETE splicer.begin(TSTT_Swap.Delaunay3D.shouldMinimize)
  return false;
  // DO-NOT-DELETE splicer.end(TSTT_Swap.Delaunay3D.shouldMinimize)
}
 ...
 */
double
TSTT_Swap::Delaunay3D_impl::calcQuality (
  /* in */ ::sidl::array<double> coords,
  /* in */ int32_t coords_size ) 
throw ( 
  ::TSTTB::Error
){
  // DO-NOT-DELETE splicer.begin(TSTT_Swap.Delaunay3D.calcQuality)
  ...
  // DO-NOT-DELETE splicer.end(TSTT_Swap.Delaunay3D.calcQuality)
}


// DO-NOT-DELETE splicer.begin(TSTT_Swap.Delaunay3D._misc)
// Insert-Code-Here {TSTT_Swap.Delaunay3D._misc} (miscellaneous code)
