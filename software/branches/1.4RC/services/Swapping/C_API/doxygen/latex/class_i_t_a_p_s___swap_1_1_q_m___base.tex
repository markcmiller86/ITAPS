...
\subsubsection[{calcQuality}]{\setlength{\rightskip}{0pt plus 5cm}virtual double ITAPS\_\-Swap::QM\_\-Base::calcQuality (const double {\em coords}\mbox{[}$\,$\mbox{]}, \/  const int {\em coords\_\-size}) const\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}
