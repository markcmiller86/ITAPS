...
int main(int argc, char* argv[]) 
{
  ...
  iMesh_load(mesh, root_set, fname, "", &err, strlen(fname), 0);
  ...
  free(entities);
  iMesh_endEntArrIter(mesh, ArrIter, &err); /* end the iterator above */
...
/*///////////////////////// PART 3: TIMING SECTION /////////////////////////////////  */
  ...
  printf("\n\n\nThanks for running the iMesh iterator example program.\n");
