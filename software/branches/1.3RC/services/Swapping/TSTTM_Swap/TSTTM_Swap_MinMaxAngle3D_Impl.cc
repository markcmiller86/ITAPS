// 
// File:          TSTTM_Swap_MinMaxAngle3D_Impl.cc
...
// babel-version = 0.9.2
// 
#include "TSTTM_Swap_MinMaxAngle3D_Impl.hh"
...
void TSTTM_Swap::MinMaxAngle3D_impl::_ctor() {
  // DO-NOT-DELETE splicer.begin(TSTTM_Swap.MinMaxAngle3D._ctor)
  // add construction details here
  // DO-NOT-DELETE splicer.end(TSTTM_Swap.MinMaxAngle3D._ctor)
}

// user defined destructor
void TSTTM_Swap::MinMaxAngle3D_impl::_dtor() {
  // DO-NOT-DELETE splicer.begin(TSTTM_Swap.MinMaxAngle3D._dtor)
  // add destruction details here
  // DO-NOT-DELETE splicer.end(TSTTM_Swap.MinMaxAngle3D._dtor)
}
 ...
 */
bool
TSTTM_Swap::MinMaxAngle3D_impl::shouldMinimize () 
throw ( 
  ::TSTTB::Error
)
{
  // DO-NOT-DELETE splicer.begin(TSTTM_Swap.MinMaxAngle3D.shouldMinimize)
  return true;
  // DO-NOT-DELETE splicer.end(TSTTM_Swap.MinMaxAngle3D.shouldMinimize)
}
 ...
 */
double
TSTTM_Swap::MinMaxAngle3D_impl::calcQuality (
  /*in*/ ::sidl::array<double> coords,
  /*in*/ int32_t coords_size ) 
throw ( 
  ::TSTTB::Error
){
  // DO-NOT-DELETE splicer.begin(TSTTM_Swap.MinMaxAngle3D.calcQuality)
  ...
  // DO-NOT-DELETE splicer.end(TSTTM_Swap.MinMaxAngle3D.calcQuality)
}
