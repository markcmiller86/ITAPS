...
/* These are the real functions any iField client will call to actually 
   ...
   is trivial. */
static void iField_DFKEvalDfunc(iField_DFuncKernel dfk_handle,
...
static void iField_DFKEvalGrad(iField_DFuncKernel dfk_handle,
			       IFIELD_DFK_EVAL_SIGNATURE)
{
...
static void iField_DFKEvalHessian(iField_DFuncKernel dfk_handle,
				  IFIELD_DFK_EVAL_SIGNATURE)
{
...
static void iField_DFKGetDOFAssoc(iField_DFuncKernel dfk_handle,
    /*in */ const int topo,
    /*out*/ int* dofs_per_vert,
    /*out*/ int* dofs_per_edge,
    /*out*/ int* dofs_per_face,
...
static void iField_DFKGetParamCoords(iField_DFuncKernel dfk_handle,
    /*in */ const iMesh_Instance instance,
    /*in */ const iBase_EntityHandle entity,
    /*in */ const double phys_coords[3],
    /*in */ const int coord_type,
...
static void iField_DFKGetPhysCoords(iField_DFuncKernel dfk_handle,
    /*in */ const iMesh_Instance instance,
    /*in */ const iBase_EntityHandle entity,
    /*in */ const double local_param_coords[3],
    /*in */ const int coord_type,
...
static void iField_DFKGetJacobian(iField_DFuncKernel dfk_handle,
    /*in */ const iMesh_Instance instance,
    /*in */ const iBase_EntityHandle entity,
    /*in */ const double local_param_coords[3],
    /*in */ const int coord_type,
...
static void iField_DFKGetName(iField_DFuncKernel dfk_handle,
    /*out*/ char *name,
    /*out*/ int *err,
    /*i/o*/ int *name_len)
{ 
