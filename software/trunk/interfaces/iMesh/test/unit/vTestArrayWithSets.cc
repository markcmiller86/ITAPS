...
//   } // Done for topo2
  ...
  if ( qErrTests ) {
    ...
    iMesh_initEntArrIter(instance,  apvSets[0], static_cast<iBase_EntityType>(iBase_ALL_TYPES+1),
			 iMesh_ALL_TOPOLOGIES, 3, 0, &pvBadIter, &err);
