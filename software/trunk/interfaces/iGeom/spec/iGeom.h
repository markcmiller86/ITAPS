 ...
 *
 * iGeom maintains a major, minor and patch digit in its version number.
 ...
 * necessitates an API change. So, we define a patch digit for iGeom
 ******************************************************************************/
 ...
 *
 * Evaluates to true at CPP time if the version of iGeom currently being
...
/***************************************************************************//**
 * \ingroup VersionNumbers
 * \brief Compose string represention of the iGeom version number
 ******************************************************************************/
#define IGEOM_VERSION_STRING ITAPS_VERSION_STRING_(iGeom)

/***************************************************************************//**
 * \ingroup VersionNumbers
 * \brief Compose a symbol name derived from the current iGeom version number.
 ******************************************************************************/
#define IGEOM_VERSION_TAG ITAPS_VERSION_TAG_(iGeom)

/***************************************************************************//**
 * \ingroup VersionNumbers
 * \brief Define iGeom_newGeom symbol such that it depends on version number.
 *
...
void iGeom_initEntIter(
    ...
    const int resilient,
        /**< [in] If zero, return a non-resilient iterator.
                  Otherise, a resilient iterator (\ref resilient) */
...
/***************************************************************************//**
 * \defgroup iGeomTagsOnArr Tag Data On Arrays of Entities
 * \ingroup iGeomTagData
 ******************************************************************************/
...
/***************************************************************************//**
 * \defgroup iGeomCoordQuery Geometric/Parametric Coordinate Queries
 * \ingroup iGeom
 ******************************************************************************/
