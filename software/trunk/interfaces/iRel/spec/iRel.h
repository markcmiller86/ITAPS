 ...
 * Description unavailable.
 *
 * <em>Note to implementors</em>: The returned iterator need only meet the
 * requirements of a non-resilient iterator.
 ******************************************************************************/
 ...
 * Description unavailable.
 *
 * <em>Note to implementors</em>: The returned iterators need only meet the
 * requirements of a non-resilient iterator.
 ******************************************************************************/
...
void iRel_rmvEntEntRelation(
    ...
    iRel_PairHandle pair,
        /**< [in] Relation pair handle being queried */
    iBase_EntityHandle ent1,
        /**< [in] 1st entity of relation being removed */
    iBase_EntityHandle ent2,
        /**< [in] 2nd entity of relation being removed */
    int* err
        /**< [out] Returned Error status (see iBase_ErrorType) */
);
...
void iRel_rmvEntArrEntArrRelation(
    ...
    iRel_PairHandle pair,
        /**< [in] Relation pair handle being queried */
    iBase_EntityHandle* ent_array_1,
        /**< [in] 1st array of entities of relation being removed */
    int num_ent1,
        /**< [in] Number of entities in 1st array */
    iBase_EntityHandle* ent_array_2,
        /**< [in] 2nd array of entities of relation being removed */
    int num_ent2,
        /**< [in] Number of entities in 2nd array */
    int* err
        /**< [out] Returned Error status (see iBase_ErrorType) */
