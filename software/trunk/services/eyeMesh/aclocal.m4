...
dnl Modifications:
dnl
dnl   Mark C. Miller, Thu May 21 09:24:40 PDT 2009
dnl   Fixed compile-time version number comparison which compared each digit in the
dnl   version number independently resulting in erroneus comparisions.
dnl
dnl   Mark C. Miller, Thu Jul  1 21:21:02 PDT 2010
dnl   Eliminated appending of 'vtk-$vtk_suffix' to path to VTK lib dir in LDFLAGS.
dnl ======================================================================================
